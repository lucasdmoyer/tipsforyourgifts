...
console.log(JSON.stringify({ generated: path.relative(root, outputPath), manifestId: manifest.manifestId, contentSetSha256: manifest.contentSetSha256, articles: manifest.counts.articles, independentReviews: manifest.counts.independentReviews, socialDrafts: manifest.counts.socialDrafts, visualAssets: manifest.counts.visualAssets, affiliateLinks: manifest.counts.affiliateLinks }, null, 2));
